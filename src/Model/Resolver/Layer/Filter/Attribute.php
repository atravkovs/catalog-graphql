...
class Attribute extends \Magento\Catalog\Model\Layer\Filter\AbstractFilter
{
    ...
    public function __construct(
        ...
        \ScandiPWA\CatalogGraphQl\Model\ResourceModel\Layer\Filter\AttributeFactory $filterAttributeFactory,
    ...
    protected function _getItemsData()
    {
        ...
        $resource = $resource->setProductCollection($this->productCollection);
